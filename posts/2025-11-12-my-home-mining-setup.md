# What I’m Running at Home: Real Hashrates, Setup, and Daily Averages
...
## 🧱 My Current Setup (~15.9–16.1 TH/s Daily)

Right now I'm running:

- **NerdQaxe++ Remastered (full copper) ×2**
- **Bitaxe Hex**
- **Bitaxe Gamma 601**
...
## ⚡ Total Daily Hashrate

Putting everything together:

- **Total daily average:** **15.9–16.1 TH/s**

This is the number I track for solo-mining, variance planning, and long-term monitoring.

---

## 🏆 My Favorite Miner (personal take)

Purely for my own setup and workflow:

### **The NerdQaxe++ Remastered (full copper) is my favorite miner.**

It combines:

- excellent thermals  
- stable performance  
- beautiful PCB + fan aesthetics  
- low headaches  
...
- Noise comparisons (real decibels measured at my desk)
- Overclocking vs. efficiency tuning
- Hourly vs. daily hashrate variance explained clearly
- Best miners for absolute beginners
- Solo-mining strategy at 16 TH/s
- Real cost-to-run based on Massachusetts electricity pricing
